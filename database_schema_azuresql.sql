...
CREATE TABLE core_producttype (
    id INT IDENTITY(1,1) PRIMARY KEY,
    name NVARCHAR(200) NOT NULL,
    active BIT NOT NULL DEFAULT 1
);

CREATE TABLE core_pitoperator (
    id INT IDENTITY(1,1) PRIMARY KEY,
    name NVARCHAR(200) NOT NULL,
...
CREATE TABLE core_capacityrule (
    id INT IDENTITY(1,1) PRIMARY KEY,
    month INT NOT NULL,
...
CREATE TABLE core_appointment (
    ...
    carrier_id INT NOT NULL FOREIGN KEY REFERENCES core_carrier(id),
    customer_id INT NOT NULL FOREIGN KEY REFERENCES core_customer(id),
    product_type_id INT NOT NULL FOREIGN KEY REFERENCES core_producttype(id)
);

-- 3. Create Driver Visit Table
CREATE TABLE core_drivervisit (
    id INT IDENTITY(1,1) PRIMARY KEY,
    ...
    notes NVARCHAR(MAX) NOT NULL DEFAULT '',
    appointment_id INT NOT NULL UNIQUE FOREIGN KEY REFERENCES core_appointment(id),
    assigned_door_id INT NULL FOREIGN KEY REFERENCES core_door(id),
    pit_operator_id INT NULL FOREIGN KEY REFERENCES core_pitoperator(id)
);
...
-- ==========================================
INSERT INTO core_customer (name, active) VALUES 
('Bayer', 1), ('Monsanto', 1), ('Pioneer', 1);

INSERT INTO core_carrier (name, active) VALUES 
('Swift', 1), ('Schneider', 1), ('J.B. Hunt', 1), ('Werner', 1);

INSERT INTO core_producttype (name, active) VALUES 
('Corn', 1), ('Soybeans', 1), ('Wheat', 1);

INSERT INTO core_pitoperator (name, initials, active) VALUES 
('John Doe', 'JD', 1), ('Jane Smith', 'JS', 1);

INSERT INTO core_door (door_name, area, direction, status, active) VALUES 
